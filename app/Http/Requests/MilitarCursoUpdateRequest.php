...
class MilitarCursoUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'curso_id' => ['required', Rule::unique('militares_cursos', 'curso_id')->ignore($this->id)->where(function ($query) {return $query->where('militar_id', $this->militar_id);})],
