            ...
            <div class="navbar-brand-box">
                ...
                <a href="index" class="logo logo-light">
                    <span class="logo-sm p-0">
                        <img src="{{ asset('/assets/images/logo_cbmerj_min_branco.png') }}" alt="" height="60" style="margin-left: -16px;">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/assets/images/logo_cbmerj_dgf_branco.png') }}" alt="" height="50">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="#" onclick="crudOffCanvaProfilleView(2, {{ session('userContext.user.id') }})"><i class="bx bx-user font-size-16 align-middle me-1"></i> {{ __('Perfil') }}</a>
