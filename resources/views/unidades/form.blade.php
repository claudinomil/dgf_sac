            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-buttons" id="crudFormButtons1">
                        <!-- store or update -->
                        @if(temPermissao('unidades_create') || temPermissao('unidades_edit'))
                        ...
                        <fieldset>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="form-group col-12 col-md-3 pb-3">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="codigo_unidade" name="codigo_unidade" required="required">
                                </div>
                                <div class="form-group col-12 col-md-3 pb-3">
                                    <label class="form-label">Situação</label>
                                    <select class="form-control" name="situacao" id="situacao" required="required">
                                        <option value="">Selecione...</option>
                                        <option value="1">Ativa - recebe efetivo</option>
                                        <option value="2">Inativa - não recebe efetivo</option>
                                    </select>
                                </div>
                                <div class="form-group col-12 col-md-3 pb-3">
                                    ...
                                    <select class="form-control" name="tipo" id="tipo" required="required">
                                        <option value="">Selecione...</option>
                                        <option value="1">SEDEC</option>
                                        <option value="2">CBMERJ</option>
                                        <option value="3">ÓRGÃO EXTERNO</option>
