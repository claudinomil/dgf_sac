        ...
        <div class="col-12">
            <div class="card border-0 mb-4">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 pb-2">
                                    @if(temPermissao('funcoes_create'))
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    @php
                                        ...
                                        ['value' => 'funcoes.name', 'descricao' => 'Funcao'],
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :colsNames="['Funcao', 'Ações']" />
...
@section('script')
    <!-- scripts_funcoes.js -->
    <script src="{{ asset('assets/js/scripts_funcoes.js')}}"></script>
@endsection
