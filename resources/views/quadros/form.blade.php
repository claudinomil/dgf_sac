            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-buttons" id="crudFormButtons1">
                        <!-- store or update -->
                        @if(temPermissao('quadros_create') || temPermissao('quadros_edit'))
                        ...
                        <fieldset>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="form-group col-12 col-md-6 pb-3">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="especialidade" name="especialidade" required="required">
                                </div>
                            </div>
                        </fieldset>
                    </form>
